...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="assets/print/PrintArea.css" />
            ...
            <div class="navbar-container ace-save-state" id="navbar-container">
                ...
                <div class="navbar-header pull-left">
                    <a href="#" class="navbar-brand">
                        <small>
                            <img src="assets/images/logo_large.png" alt="Helooo" style=" max-height: 50px; max-width: 120px;">
                            <span style="font-size: 17px;">A-School</span>
                        </small>
                    </a>
